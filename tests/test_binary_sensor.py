...
async def test_charging_binary_sensor_on(
...
async def test_charging_binary_sensor_zero_power(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_connected_binary_sensor_on(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_connected_binary_sensor_off(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_connected_binary_sensor_stale_heartbeat(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_connected_binary_sensor_recent_heartbeat(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_connected_binary_sensor_attributes(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_connected_binary_sensor_no_heartbeat_attributes(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
