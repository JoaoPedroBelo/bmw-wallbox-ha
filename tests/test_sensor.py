...
async def test_status_sensor_offline(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_status_sensor_paused(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_status_sensor_attributes(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_connector_status_sensor_unknown(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_connector_status_sensor_available(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_stopped_reason_sensor(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_event_type_sensor(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_trigger_reason_sensor(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_id_token_sensor(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_phases_used_sensor(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_sequence_number_sensor(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_state_sensor_map(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_state_sensor_offline(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_current_sensor_with_phases(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_current_sensor_zero_returns_none(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_voltage_sensor_with_phases(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
...
async def test_voltage_sensor_zero_returns_none(
    hass: HomeAssistant, mock_coordinator, mock_config_entry
) -> None:
